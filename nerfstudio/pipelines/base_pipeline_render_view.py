...
from nerfstudio.configs import base_config_render_view as cfg
...
from nerfstudio.models.base_model_render_view import Model, ModelConfig
from nerfstudio.utils import profiler_render_view
...
class VanillaPipeline(Pipeline):
    ...
    def __init__(
        ...
        self._model = config.model.setup(
            scene_box= SceneBox(), # self.datamanager.train_dataset.scene_box,
            num_train_data=0,
