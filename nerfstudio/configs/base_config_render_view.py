...
# model instances
from nerfstudio.utils import writer_render_view
...
class LocalWriterConfig(InstantiateConfig):
    ...
    _target: Type = writer_render_view.LocalWriter
    """target class to instantiate"""
    enable: bool = False
    """if True enables local logging, else disables"""
    stats_to_track: Tuple[writer_render_view.EventName, ...] = (
        writer_render_view.EventName.ITER_TRAIN_TIME,
        writer_render_view.EventName.TRAIN_RAYS_PER_SEC,
        writer_render_view.EventName.CURR_TEST_PSNR,
        writer_render_view.EventName.VIS_RAYS_PER_SEC,
        writer_render_view.EventName.TEST_RAYS_PER_SEC,
        writer_render_view.EventName.ETA,
    )
